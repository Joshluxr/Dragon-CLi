...
import type { AIModelExternal } from "@dragon/agent/types";
...
program
  .name("toothless")
  .description("Toothless CLI - Dragon Labs coding assistant")
  .version(packageJson.version);

program
  .command("auth [apiKey]")
  .description("Authenticate with your Dragon API key")
