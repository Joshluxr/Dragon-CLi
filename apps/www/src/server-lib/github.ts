...
import { getAutomation } from "@dragon/shared/model/automations";
import { getThreadMinimal } from "@dragon/shared/model/threads";
...
> {
  return {
    name: `Dragon Automation - ${automation.name}`,
    output: {
