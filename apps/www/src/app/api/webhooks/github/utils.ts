...
import { AccessInfo } from "@dragon/shared/db/types";
import { db } from "@/lib/db";
import { getUserIdByGitHubAccountId } from "@dragon/shared/model/user";
...
export async function postBillingLinkComment({
  ...
  const body = `To use Dragon from GitHub, please set up billing here: ${billingUrl}`;
