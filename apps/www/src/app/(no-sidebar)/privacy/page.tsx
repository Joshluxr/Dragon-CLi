...
export const metadata: Metadata = {
  title: "Privacy Policy - Dragon Labs",
  description:
    "Privacy Policy for Dragon Labs Inc. Learn how we collect, use, and protect your personal information when using our AI-powered coding assistant platform.",
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: "https://dragon-labz.vercel.app/privacy",
  },
};
        ...
        <article className="prose prose-slate max-w-none">
          <header className="text-center mb-12">
            <h1 className="text-4xl font-bold tracking-tight text-foreground mb-4">
              Dragon Labs Inc. Privacy Policy
            </h1>
          ...
          <div className="space-y-8 text-foreground leading-relaxed">
            <section>
              <p className="text-lg leading-relaxed">
                ...
                when you access or use our website at dragon-labz.vercel.app,
                its documentation, and related services (the "Services").
              </p>
            </section>
