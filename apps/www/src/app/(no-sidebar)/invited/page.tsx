...
import { validateAccessCode } from "@dragon/shared/model/access-codes";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Join Dragon with your exclusive access code and start using background agents for Claude Code.",
    url: "https://dragon-labz.vercel.app/invited",
    siteName: "Dragon",
    images: [
      {
        url: OG_IMAGE_URL,
        width: 1200,
        height: 630,
        alt: "Dragon - Background agents for Claude Code",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  alternates: {
    canonical: "https://dragon-labz.vercel.app/invited",
  },
  robots: {
    index: false,
    follow: false,
