    ...
    <div className="flex flex-col min-h-[100dvh] w-full">
      <div className="flex-1 flex flex-col gap-12 items-center justify-center px-4 py-16">
        <div className="w-full max-w-[95%] max-w-md flex flex-col gap-6">
          ...
          <div className="text-center space-y-4">
            <h2 className="text-lg text-muted-foreground">
              You've been invited! Welcome to Dragon.
            </h2>
          </div>
        ...
        <section className="w-full max-w-lg" aria-label="Product demo video">
          ...
          >
            <video
              src="https://cdn.dragonlabs.com/hero_slow.webm"
              className="w-full h-full object-cover"
              autoPlay
              loop
              muted
              playsInline
              aria-label="Dragon platform demonstration"
            />
      ...
      <footer className="p-4">
        <div className="text-center text-sm text-muted-foreground">
          <div>© {new Date().getFullYear()} Dragon</div>
        </div>
      </footer>
