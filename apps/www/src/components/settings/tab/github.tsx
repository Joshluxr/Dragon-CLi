  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <SettingsSection label="Repository Configuration">
        <div className="flex flex-col gap-4">
          <SettingsWithExternalLink
            ...
            description="Manage which GitHub repositories Dragon can access"
      ...
      <SettingsSection
        ...
        description="Configure how Dragon creates and manages pull requests"
      >
        <div className="flex flex-col gap-4">
          <SettingsWithCTA
            label="Default pull request stage"
            description="Set the default stage of pull requests Dragon creates"
          >
