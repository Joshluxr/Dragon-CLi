...
import { UIMessage, ThreadStatus } from "@dragon/shared";
import { AIAgent } from "@dragon/agent/types";
import { BootingSubstatus } from "@dragon/sandbox/types";
...
function getBootingSubstatusMessage(substatus: BootingSubstatus): string {
  switch (substatus) {
    ...
    case "running-setup-script":
      return "Running dragon-setup.sh";
    case "booting-done":
...
function getAgentRateLimitMessage({
  ...
  return (
    <div className="flex flex-col">
      ...
      {agent === "claudeCode" && (
        <Link
          href="https://dragon-labz-docs.vercel.app/docs/agent-providers/claude-code#automatic-rate-limit-handling"
          target="_blank"
