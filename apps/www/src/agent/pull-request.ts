...
import { getGithubPRStatus } from "@dragon/shared/github-api/helpers";
import { upsertGithubPR } from "@dragon/shared/model/github";
import { updateThread, getThread } from "@dragon/shared/model/threads";
import {
...
export async function openPullRequestForThread({
  ...
  prBody += [
    "\n\n",
    "🌿 Generated by [Toothless](https://www.dragonlabs.com)",
    "\n\n---\n\n",
    "ℹ️ Tag @dragon-labs to ask questions and address PR feedback",
    "\n\n",
