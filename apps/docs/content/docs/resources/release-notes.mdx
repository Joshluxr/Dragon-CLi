...
- **Amp Agent**: Dragon now supports [Amp](https://ampcode.com). Configure your Amp API key in [Settings](https://www.terragonlabs.com/settings/agent) to use this powerful alternative to Claude and Codex.
...
- **Branch name prefix customization**: You can now customize the branch prefix added to Dragon-generated branches (defaults to `dragon/`). Update this in [Settings](https://www.terragonlabs.com/settings).
