...
![Multiple credentials](/cdn/multiple-credentials-1zLJ.png)
...
![Branch control](/cdn/branch-toggle-vTKc.png)
...
![Task forking](/cdn/fork-task-yW3l.png)
...
- **Configure available agents and models**: You can now configure which available agents and models show up in the model selector in prompt boxes.
  ...
  ![Agent settings](/cdn/agent_settings-cCI5.png)

- **New features in [early access](/docs/resources/early-access-features)**:

  - **Git diff viewer and file tree**: View diffs in a responsive secondary panel inside of tasks.

    ![Diff viewer](/cdn/diff_viewer-gH9X.png)
...
![Multi-Hour Schedule Automations](/cdn/multi-hour-schedule-8b3S.png)
...
- **New features in [early access](/docs/resources/early-access-features)**:
  - **Multi-Agent Mode**: Run multiple AI agents from one prompt. This is useful when you want to compare different approaches or if you're not sure if a specific model is the best fit for your task.
    ![Multi-Agent Mode](/cdn/multi-agent-mode-5K1D.png)
...
- **Slack Integration**: Create tasks directly in Slack! Connect your Slack workspace from the new [Integration Settings page](https://www.dragonlabs.com/settings/integrations), where you can also set a default repo and default model for tasks created from Slack. Check out the [Slack integration documentation](/docs/integrations/slack-integration) for setup instructions and usage examples.
  ...
  ![Slack integration settings](/cdn/slack-integration-QVNL.png)
...
- **Quick GitHub Actions** ([Early access](/docs/resources/early-access-features)):
  ...
  - For tasks with associated PRs, certain quick actions are available above the prompt box:
    - PRs that have failing GitHub checks will have a "Fix it" button to automatically address CI failures.
      ![Fix it button for failed GitHub checks](/cdn/gh-fix-it--MWU.png)
    - Draft PRs that have passing GitHub checks will have a "Ready for review" button to as ready.
      ![Ready for review button](/cdn/gh-ready-for-review-fi8d.png)
...
- **Schedule individual tasks**: You can now schedule individual tasks to run at a specific time in the future from the prompt box. Note: If you want to run a task on a recurring schedule, do so from the [Automations](https://www.dragonlabs.com/automations) page.
  ![Schedule tasks](/cdn/schedule-tasks-esMN.png)
