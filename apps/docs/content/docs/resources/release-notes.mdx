...
- **GPT-5.1**: GPT-5.1 and GPT-5.1 Codex models are now supported.
  - You can still access the older GPT-5 models by enabling them in [Settings](https://dragon-labz.vercel.app/settings/agent).
- **Gemini 2.5 Pro**: The OpenCode agent now supports Gemini 2.5 Pro. Enable this model in [Settings](https://dragon-labz.vercel.app/settings/agent) to use it.
...
- **Slack Integration**: Create tasks directly in Slack! Connect your Slack workspace from the new [Integration Settings page](https://dragon-labz.vercel.app/settings/integrations), where you can also set a default repo and default model for tasks created from Slack. Check out the [Slack integration documentation](/docs/integrations/slack-integration) for setup instructions and usage examples.
...
- **Environment Management**: You can now delete environments and their associated data after selecting an environment from the [Environments](https://dragon-labz.vercel.app/environments) page.
...
- **Amp Agent**: Dragon now supports [Amp](https://ampcode.com). Configure your Amp API key in [Settings](https://dragon-labz.vercel.app/settings/agent) to use this powerful alternative to Claude and Codex.
...
- **GitHub Integration Improvements**:
  ...
  - You can now specify a default model for new tasks when @terragon-labs is mentioned. Update this in [Settings](https://dragon-labz.vercel.app/settings/github)
...
- **Schedule individual tasks**: You can now schedule individual tasks to run at a specific time in the future from the prompt box. Note: If you want to run a task on a recurring schedule, do so from the [Automations](https://dragon-labz.vercel.app/automations) page.
  ![Schedule tasks](/cdn/schedule-tasks-esMN.png)

- **GitHub issue and pull request automation triggers**: Automations can now be triggered when GitHub issues and pull requests are created or updated in a repository. Helpful for automatically triaging new GitHub issues, creating tasks to implement a GitHub issue, or doing custom code reviews on pull requests. Accessible from the [Automations](https://dragon-labz.vercel.app/automations) page. Check out our docs for [example prompts](/docs/tasks//automations#example-use-cases).
...
- **Branch name prefix customization**: You can now customize the branch prefix added to Dragon-generated branches (defaults to `dragon/`). Update this in [Settings](https://dragon-labz.vercel.app/settings).
...
- **Setup Script Editor Improvements**: The setup script editor now streams output in real-time so you'll see live feedback as you test changes. Access this by clicking on one of your environments from the [Environments](https://dragon-labz.vercel.app/environments) page.
...
- Fixed page load performance when loading dragon-labz.vercel.app. There were some cases of very slow connections, which are now resolved.
...
- **Connect your ChatGPT subscription to use with Codex**: You can now use an existing ChatGPT subscription to power the Codex agent instead of providing an OpenAI API key. Just go to [Settings](https://dragon-labz.vercel.app/settings) and navigate to the ChatGPT Account section. If you already have an OpenAI API key connected, you'll need to disconnect that first if you want to connect your ChatGPT subscription.
...
- Fixed a bug where Codex didn't respect custom system prompts, available in [Settings](https://dragon-labz.vercel.app/settings)
...
- **Support for SSE MCP servers**: You can now use SSE-based MCP servers, in addition to the previously supported command-based and HTTP-based MCP servers. Add and update MCP configurations from [Environments](https://dragon-labz.vercel.app/environment)
...
- **Diff Context in GitHub mentions**: Mentioning @terragon-labs in GitHub PR comments now includes context of the diff in the message back to Dragon
...
- **Task Sharing**: Share your tasks with your collaborators:
  ...
  - You can change sharing permissions via the share modal on a task or in [Settings](https://dragon-labz.vercel.app/settings)
