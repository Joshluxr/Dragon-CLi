...
<Steps>
  <Step>
    Navigate to [<Settings className="inline-block w-4 h-4 mx-1" /> **Settings**](https://www.dragonlabs.com/settings)
  </Step>
  <Step>
    Find the `Early access features` setting and toggle the setting on
  </Step>
  <Step>
    Once enabled, an `Early Access` pill will appear at the top right of [<House className="inline-block w-4 h-4 mx-1" /> **Home**](https://www.dragonlabs.com) and [<Settings className="inline-block w-4 h-4 mx-1" />**Settings**](https://www.dragonlabs.com/settings)
  </Step>
</Steps>
