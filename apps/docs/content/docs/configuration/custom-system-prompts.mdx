...
description: Configure custom system prompts to give Dragon specific instructions for your development workflow.
---
...
<Steps>
  <Step>
    Navigate to [<Settings className="inline-block w-4 h-4 mx-1" /> **Settings**](https://dragon-labz.vercel.app/settings/agent)
  </Step>
...
Dragon considers both when working on your code.
