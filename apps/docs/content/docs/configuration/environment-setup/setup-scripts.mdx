---
title: Setup Scripts
description: Configure custom setup scripts that run when your Dragon sandbox starts.
---
...
<Callout type="info">
  Configured in your Dragon environment settings, this script is private to you and takes precedence over repository scripts.
...
<Steps>
  <Step>
    ...
    **Environments**](https://dragon-labz.vercel.app/environments)
  </Step>
...
Add a `dragon-setup.sh` file to the root of your repository
...
You can skip running the `dragon-setup.sh` script when creating tasks and automations by toggling the **Skip Repository Setup** setting in the task or automation creation UI.
