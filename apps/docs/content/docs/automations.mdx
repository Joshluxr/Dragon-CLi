...
<Steps>
  <Step>
    ...
    **Automations**](https://dragon-labz.vercel.app/automations) from the sidebar
  </Step>
...
To see all of the past runs and tasks created by an Automation, click on it from [<Workflow className="inline-block w-4 h-4 mx-1" /> **Automations**](https://dragon-labz.vercel.app/automations). This is helpful for ensuring your Automations are completing as expected.
