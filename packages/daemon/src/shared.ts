...
import { AIAgentSchema } from "@dragon/agent/types";

export const defaultPipePath = "/tmp/dragon-daemon.pipe";
export const defaultUnixSocketPath = "/tmp/dragon-daemon.sock";
